...
// Accessing the earthquake GeoJSN Data.

let sumearthquake = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";

// Retrieve the earthquake GeoJSON data.
d3.json(sumearthquake).then(function(data) {
  ...
  // Accessing the Tectonic GeoJSN Data.
